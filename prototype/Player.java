...
/***************************************************************
 * The Player class defines field variables that contain information about a
 * player.
 *
...
public class Player {
    ...
    /***************************************************************
     * Constructor for a Player object. It takes a name and a color to save as
     * field values for this Player.
     *
     * @param name
     ...
     ***************************************************************/
    public Player(final String name, final ColorStatus color) {
    ...
    /***************************************************************
     * Get method for the color of the Player and the color of a standard
     * checker.
     *
