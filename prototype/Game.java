...
/***************************************************************
* This holds the logic behind the game, for example the button
* Logic, if the game is running, and the current player.
...
public class Game extends Observable implements Observer {
	...
	/***************************************************************
	* Constructor for a Game object. adds the players, panels, and
	* sets current player to white. it also sets the time.
	* @param panel
	...
	***************************************************************/
	...
	/***************************************************************
	* Sets the players names within thre GUI
	***************************************************************/
