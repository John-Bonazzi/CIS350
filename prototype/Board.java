...
public class Board extends Observable {
	...
	* @return True if the player can be selected or false if it cannot be selected
	***************************************************************/
	...
	* @param fc
	*				The column the pece moves from.
	* return true if the piece can move or false if it cannot move.
	***************************************************************/
	...
	/***************************************************************
	* A boolean method that checks if the piece can move in any
	* direction
	* @param player
	*				A instance of the ColorStatus that gets the color of the player.
	* @param king
	...
	* 					A instance of the Player Object
	* @param row
	* 				The row of the piece that is being hecked if a double jump is possible
	* @param col
	* 				The column of the piece that is being hecked if a double jump is possible
	...
	**************************************************************/
	...
	/***************************************************************
	* A boolean method that Shows the player whose turn it is the
	* current pieces that can be moved that turn.
	* @param player
	...
	* @return true or false depending on if the piece at specific row and column has a has a move.
	***************************************************************/
	...
	/***************************************************************
	* A boolean method in which determines if the piece can jump
	* another piece.
	* @param player
	*					A instance of the Player object
	* @param king
