...
public class Checkers_GUI extends JFrame implements Observer {
	...
	/*
	 * Buttons to:
	 * Start a new game, Forfeit the game, and start a new game vs AI.
	 */
	...
	**************************************************************/
	...
	/**************************************************************
	 * Initializes everything in the stats panel (Bottom)
	 * and handles the formatting and components within.
	**************************************************************/
	...
	/**************************************************************
	 * Method to change the time display label and handle seconds -> minutes.
	 * @param time
	...
	**************************************************************/
	...
	/**************************************************************
	 * This private class handles the action listener functions
	 * for all the buttons in the GUI.
	**************************************************************/
