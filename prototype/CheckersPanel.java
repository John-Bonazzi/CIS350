...
/**************************************************************
* This class is the panel in which most of the graphical work is done.
* It draws the checkerboard and calls most of the game logic functions.
...
public class CheckersPanel extends JPanel implements Observer{
	...
	//This is a variable that holds a percentage that many calculations use for ease of use.
	private final float PERCENTAGE = (float) 0.75;
	//Field variable for the board object.
	private Board board;
	//Field variable for the game object.
	private Game game;
	//2D array of ColorStatus that represents the board and checker placement.
	...
	//Varies between possible checkers and possible moves of a certain checker.
	private boolean[][] options;
	//Frame holding this panel to update the timer.
	private Checkers_GUI parentFrame;
	//Timer object.
	private Timer gameTimer;
	//Graphics object updated every time paintComponent is called. allows global access.
	private Graphics g;
	//Boolean to determine if you are against a player or AI.
	private boolean againstAI;
	//boolean to determine if this is the first time you have clicked on a square.
	...
	**************************************************************/
	...
	/**************************************************************
	 * Creates all of the dimensions for the board and sets field variables
	 * to those values.
	**************************************************************/
	...
	/**************************************************************
	 * This is the method that is called and draws nearly everything on the board.
	 * @param graph
