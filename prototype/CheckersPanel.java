...
public class CheckersPanel extends JPanel implements Observer {
    ...
    private CheckersGUI parentFrame;
    ...
    public CheckersPanel(final int xSize, final int ySize,
        ...
        options = canMove;
        this.gameTimer = new Timer(timerDelay, new TimerListener());
    ...
    /**************************************************************
     * Start a new game.
     * This method contains all methods calls to make
     * sure a brand new game is started.
    ...
    private void makeAIturn() {
        ...
        if (this.againstAI && this.game.isGameRunning()) {
            CheckersAI gameAI = (CheckersAI) game.getCurrentPlayer();
            gameAI.makeMove(this.board, this.options, this.game);
